...
from src.gui.views.columns.ui_right_column import Ui_RightColumn
from src.gui.views.pages.main_pages_ui import Ui_MainPages
...
class UI_MainWindow(object):
    def setup_ui(self, parent):
        ...
        self.window = PyWindow(
            parent,
            bg_color = self.themes["app_color"]["blue_one"],
            border_color = self.themes["app_color"]["bg_one"],
            text_color = self.themes["app_color"]["text_foreground_two"]
        )
        ...
        self.left_menu = PyLeftMenu(
            ...
            bg_one = self.themes["app_color"]["blue_one"],      # Originally, bg_one
            icon_color = self.themes["app_color"]["bg_one"],        # icon_color
            icon_color_hover = self.themes["app_color"]["icon_hover"],
            icon_color_pressed = self.themes["app_color"]["icon_pressed"],
            icon_color_active = self.themes["app_color"]["bg_three"],     # Previosuly icon_active
            context_color = self.themes["app_color"]["blue_one"],     # context_color shows a highlighted tip to the icon button edge, was edited to bg_one
            text_foreground = self.themes["app_color"]["bg_two"],      # text_foreground
            text_active = self.themes["app_color"]["dark_four"]       # text_active
        )
        ...
        self.left_column = PyLeftColumn(
            ...
            bttn_color = self.themes['app_color']['bg_three'],
            bttn_color_hover = self.themes['app_color']['bg_two'],
            bttn_color_pressed = self.themes['app_color']['bg_one'],
        ...
        self.title_bar = PyTitleBar(
            ...
            bttn_bg_color = self.themes["app_color"]["bg_two"],
            bttn_bg_color_hover = self.themes["app_color"]["bg_three"],
            bttn_bg_color_pressed = self.themes["app_color"]["bg_one"],
            icon_color = self.themes["app_color"]["icon_color"],
            icon_color_hover = self.themes["app_color"]["icon_hover"],
            icon_color_pressed = self.themes["app_color"]["icon_pressed"],
